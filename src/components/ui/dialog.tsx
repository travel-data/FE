...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-body2 font-semibold', className)}
      {...props}
    />
  )
}
